...
import { rawNewsList, HOTLINE } from '../NewsPage/constants';
...
const sidebarCategories: SidebarCategory[] = [
   { id: 6, name: "Máy cắt cỏ", slug: "may-cat-co", icon: <ScissorOutlined /> },
   { id: 3, name: "Đầu xịt áp lực (Ty sứ/inox)", slug: "thiet-bi-xit-rua", icon: <ThunderboltOutlined /> },
   { id: 9, name: "Máy nén khí", slug: "may-nen-khi", icon: <DashboardOutlined /> },
   { id: 10, name: "Dụng cụ cầm tay", slug: "dung-cu-cam-tay", icon: <ToolOutlined /> },
   { id: 7, name: "Máy xới đất", slug: "may-xoi-dat", icon: <BuildOutlined /> },
   { id: 8, name: "Máy bơm nước", slug: "may-bom-nuoc", icon: <FormatPainterOutlined /> },
   { id: 99, name: "Hàng thanh lý - Xả kho", slug: "hang-thanh-ly", icon: <FireOutlined /> }
];
      ...
      >
         ...
         <div className="grid grid-cols-12 gap-2 md:gap-4 relative">
                  ...
                  {sidebarCategories.map((sub: SidebarCategory) => {
                     ...
                     return (
                        <div
                           ...
                           className={`px-2 py-1.5 md:px-4 md:py-2.5 rounded-md cursor-pointer transition-all flex items-center justify-between group text-[10px] sm:text-xs font-semibold ${
                              isActive
                        ...
                        >
                           ...
                           <ArrowRightOutlined
                              className={`text-[9px] md:text-[10px] transition-all transform ${
                                 isActive
            ...
            <div className="col-span-8 md:col-span-9 h-[260px] sm:h-[320px] md:h-[400px] relative rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800/30 shadow-md shadow-gray-100/50 dark:shadow-none bg-white dark:bg-[#1f1f1f]">
               ...
               <div className={`absolute inset-0 grid grid-cols-12 gap-1 sm:gap-2 md:gap-4 p-0 transition-opacity duration-300 ${
               ...
               {currentSub && (
                  <div className={`absolute inset-0 bg-white dark:bg-[#1f1f1f] p-4 md:p-5 flex flex-col gap-4 md:gap-5 overflow-y-auto transition-all duration-300 ${
                     hoveredSubId !== null ? 'opacity-100 z-20 pointer-events-auto' : 'opacity-0 z-0 pointer-events-none'
                  }`}>

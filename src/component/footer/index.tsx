...
import { Modal, Divider, Input, Button, ConfigProvider, theme } from 'antd';
import {
  EnvironmentOutlined,
  PhoneOutlined,
  MailOutlined,
...
const AppFooter = () => {
  ...
  return (
    <ConfigProvider theme={{ algorithm: theme.defaultAlgorithm }}>
      <footer className="bg-gray-100 pt-16 pb-8 px-5 md:px-10 lg:px-24 font-sans border-t border-gray-200 transition-colors duration-300 text-gray-800">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="space-y-3 text-sm text-gray-600 w-full">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>
                  ...
                  <a href={`tel:${HOTLINE.replace(/\./g, '')}`} className="!text-gray-600 hover:!text-red-600 transition-colors">
                    {HOTLINE}
                  </a>
                </span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span>
                  ...
                  <a href={`mailto:${EMAIL}`} className="!text-gray-600 hover:!text-red-600 transition-colors">
                    {EMAIL}
                  </a>
                </span>
              </div>
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div className="flex flex-col">
              ...
              <LinkItem href="#" onClick={(e: React.MouseEvent) => { e.preventDefault(); showModal(); }}>Đường đến {COMPANY_NAME}</LinkItem>
            </div>
          </div>
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div className="bg-white p-3 rounded-lg shadow-sm inline-block w-full sm:w-auto border border-gray-100">
